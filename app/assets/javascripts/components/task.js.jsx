class Task extends React.Component{
  ...
  render(){
    ...
    let start_date = this.state.editable ? <input type='text' ref={input => this.start_date = input} defaultValue={this.props.task.start_date}/>:<p>{this.props.task.start_date}</p>
